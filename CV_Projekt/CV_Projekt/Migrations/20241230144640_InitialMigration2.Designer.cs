...
namespace CV_Projekt.Migrations
{
    ...
    [Migration("20241230144640_InitialMigration2")]
            ...
            modelBuilder.Entity("CV_Projekt.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 238, DateTimeKind.Local).AddTicks(4616),
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 12, 30, 15, 46, 38, 246, DateTimeKind.Local).AddTicks(9896),
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 246, DateTimeKind.Local).AddTicks(9760),
            ...
            modelBuilder.Entity("CV_Projekt.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "16d1c46f-8459-4a27-a471-251493a12f7f",
                            ...
                            SecurityStamp = "00777926-36ec-4e6c-8c34-3d7144c3c498",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eb7f35c8-9a8b-4a54-aac0-22147cb69062",
                            EmailConfirmed = false,
                            FirstName = "Bob",
                            InformationId = 2,
                            LastName = "Bergström",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "92bee8aa-09d9-408e-9c49-65f3089c1d91",
                            TwoFactorEnabled = false,
                            isActive = true,
                            isPrivate = false
                        },
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2708b83b-0614-43a7-9bc6-ad80593fb9bf",
                            EmailConfirmed = false,
                            FirstName = "Charlie",
                            InformationId = 3,
                            LastName = "Carlsson",
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c0fb5871-70ad-4ae4-9e97-1c7813a20e94",
                            TwoFactorEnabled = false,
                            isActive = false,
                            isPrivate = false
                        });
            ...
            modelBuilder.Entity("CV_Projekt.Models.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 327, DateTimeKind.Local).AddTicks(6846),
                            UserId = 2,
                            Level = "Gymnasial",
                        ...
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 327, DateTimeKind.Local).AddTicks(8188),
                            UserId = 3,
                            Level = "Kandidat",
                            Program = "Arkelogi"
                        });
            ...
            modelBuilder.Entity("CV_Projekt.Models.OtherExperience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 319, DateTimeKind.Local).AddTicks(6536),
                            UserId = 2,
                            Type = "Praktik"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 319, DateTimeKind.Local).AddTicks(8290),
                            UserId = 1,
                            Type = "Kurs"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 319, DateTimeKind.Local).AddTicks(8674),
                            UserId = 1,
                            Type = "Volentärarbete"
                        });
                });
            ...
            modelBuilder.Entity("CV_Projekt.Models.Work", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Location = "Café Deed",
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 324, DateTimeKind.Local).AddTicks(4697),
                            UserId = 1,
                            Role = "Arbetsledare"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 324, DateTimeKind.Local).AddTicks(5294),
                            UserId = 2,
                            Role = "Sjuksköterska"
                        },
                        new
                        {
                            ...
                            StartDate = new DateTime(2024, 12, 30, 15, 46, 38, 324, DateTimeKind.Local).AddTicks(5305),
                            UserId = 3,
                            Role = "Arbetstitel"
                        });
                });
